...
from gateway.domain.events import ProviderEvent, TextDelta
...
class RequestObserver:
    ...
    def fail(self, error: GatewayError, phase: str) -> None:
        ...
        self.log.warning("inference_failed", error_code=error.code, phase=phase)
    ...
    def _finish(self, outcome: str) -> None:
        ...
        if outcome == "success":
            self.log.info("inference_completed", duration_seconds=duration)
